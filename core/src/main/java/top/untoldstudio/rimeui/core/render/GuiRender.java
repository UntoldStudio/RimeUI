...
public abstract class GuiRender {
    ...
    public void drawSquare(ScaleOffset min, ScaleOffset max, RGBA color){
        ScaleOffset pointA = min.withXOffset(max.getXPixelInParent());
        ScaleOffset pointB = min.withYOffset(max.getYPixelInParent());
    ...
    public void drawTriangle(ScaleOffset positionA, ScaleOffset positionB, ScaleOffset positionC, RGBA colorA, RGBA colorB, RGBA colorC){
        drawTriangle(positionA.getXPixelInParent(), positionA.getYPixelInParent(), positionB.getXPixelInParent(), positionB.getYPixelInParent(), positionC.getXPixelInParent(), positionC.getYPixelInParent(),
    ...
    public void drawTexture(int textureId, ScaleOffset min, ScaleOffset max, RGBA color){
        ...
        drawTexture(textureId, min.getXPixelInParent(), min.getYPixelInParent(), max.getXPixelInParent(), max.getYPixelInParent(),
                0, 1, 0, 1,
    ...
    public void drawString(String text, Font font, ScaleOffset startDrawPosition, int fontSize, RGBA color, double italicDegrees, int boldStrength) {
        ...
        float penX = startDrawPosition.getXPixelInParent();
        float penY = startDrawPosition.getYPixelInParent() + ascenderPx;
    ...
    public void drawNiceGridTexture(int textureId, ScaleOffset position, ScaleOffset size,
        ...
        int positionX = position.getXPixelInParent();
        int positionY = position.getYPixelInParent();
        int targetWidth = size.getXPixelInParent();
        int targetHeight = size.getYPixelInParent();
