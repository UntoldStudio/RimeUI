...
import top.untoldstudio.simpleui.common.event.WindowSizeChangeEvent;
...
public class ScrollFrame extends Frame {
    ...
    private void setScrollBar(){
        String path = "textures/default_scroll_bar.png";
        ImageManager manager = ImageManager.getInstance();
        scrollBar = new ImageButton(
                new ImageData(path, manager.getTextureWidth(path), manager.getTextureHeight(path), 0, 20, 0, 20),
