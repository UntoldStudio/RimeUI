...
public final class Gui {
    ...
    public void render(GuiRender render){
        ...
        int newWindowSizeX = provider.getWindowWidth();
        int newWindowSizeY = provider.getWindowHeight();
        double newMouseX = provider.getMouseX();
        double newMouseY = provider.getMouseY();
