...
public record LayoutVector2(double xScale, int xOffset, double yScale, int yOffset) {
    ...
    public int getXAllPixel(){
        return (int) Math.round(Minecraft.getInstance().getWindow().getGuiScaledWidth() * xScale) + xOffset;
    }
    public int getYAllPixel(){
        return (int) Math.round(Minecraft.getInstance().getWindow().getGuiScaledHeight() * yScale) + yOffset;
    }
    public double getAllScaleX(){
        return (double) getXAllPixel() / (double)Minecraft.getInstance().getWindow().getGuiScaledWidth();
    }
    public double getAllScaleY(){
        return (double) getYAllPixel() / (double)Minecraft.getInstance().getWindow().getGuiScaledHeight();
    }
